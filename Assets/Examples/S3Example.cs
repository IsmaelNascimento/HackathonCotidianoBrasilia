...
namespace AWSSDK.Examples
{
    ...
    {
        public static S3Example Instance;
        ...
        {
            print(string.Format("fetching {0} from bucket {1}", SampleFileName, S3BucketName));
        ...
        {
            print(string.Format("deleting {0} from bucket {1}", SampleFileName, S3BucketName));
